  ...
  return (
    <div style={{ background: '#00274C', minHeight: '100vh', fontFamily: 'sans-serif', color: '#fff' }}>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '7rem 2.5rem 5rem' }}>
        ...
        {/* WHAT IS STUDYARENA */}
        <div id="about">
          <div style={{ fontFamily: 'monospace', fontSize: '0.68rem', letterSpacing: '0.16em', textTransform: 'uppercase', color: 'rgba(255,203,5,0.7)', marginBottom: '1rem' }}>
            What is StudyArena?
          </div>
          <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: 900, color: '#fff', letterSpacing: '-0.01em', marginBottom: '1.25rem', lineHeight: 1.1 }}>
        ...
        <div id="mission">
          ...
          <h2 style={{ fontSize: 'clamp(1.5rem, 4vw, 2.5rem)', fontWeight: 900, color: '#fff', letterSpacing: '-0.01em', marginBottom: '1.25rem' }}>
        ...
        <div id="how">
          ...
          <h2 style={{ fontSize: 'clamp(1.5rem, 4vw, 2.5rem)', fontWeight: 900, color: '#fff', letterSpacing: '-0.01em', marginBottom: '2.5rem' }}>
            Three steps.
          </h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 1, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.06)' }}>
            {[
              ...
              <div key={s.num}
                style={{ background: '#00274C', padding: '2rem 1.75rem', transition: 'background 0.2s' }}
                onMouseEnter={e => (e.currentTarget as HTMLDivElement).style.background = 'rgba(255,255,255,0.04)'}
                onMouseLeave={e => (e.currentTarget as HTMLDivElement).style.background = '#00274C'}
              >
                <div style={{ fontSize: '3rem', fontWeight: 900, color: 'rgba(255,203,5,0.15)', lineHeight: 1, marginBottom: '1rem', fontFamily: 'monospace' }}>{s.num}</div>
